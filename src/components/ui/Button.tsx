...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({
  ...
  const variants = {
    primary: 'bg-global-3 text-global-12 hover:bg-global-6 active:bg-global-1 focus:ring-global-3',
    secondary:
      'bg-global-10 text-global-2 hover:bg-global-8 active:bg-global-6 focus:ring-global-8',
    outline:
      'border border-global-7 text-global-7 bg-transparent hover:bg-global-8 active:bg-global-6 focus:ring-global-7',
    ghost: 'text-global-7 bg-transparent hover:bg-global-8 active:bg-global-6 focus:ring-global-7',
    custom: 'bg-global-3 text-global-12 hover:bg-global-6 active:bg-global-1 focus:ring-global-3',
  };

  const sizes = {
    xs: 'px-2 py-1 text-xs sm:px-2.5 sm:py-1.5 sm:text-xs',
    sm: 'px-2.5 py-1.5 text-xs sm:px-3 sm:py-2 sm:text-sm md:text-sm',
    md: 'px-3 py-2 text-sm sm:px-8 sm:py-5 sm:text-base md:text-base lg:px-[34px] lg:py-[22px] lg:text-[13px]',
