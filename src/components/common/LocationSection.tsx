    ...
    <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
      <div className="w-full container mx-auto">
        ...
        <p className="text-sm lg:text-[14px] font-montserrat font-normal leading-relaxed text-global-7 max-w-4xl mb-8 lg:mb-12">
          У Woodnest ми розуміємо важливість доступності та зручності. Розташований у мальовничій та
          спокійній місцевості, наше котеджницьке містечко також знаходиться в безпосередній
          близькості до різноманітної зовнішньої інфраструктури, яка
          <br />
